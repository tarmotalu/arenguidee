class SettingsController < ApplicationController
  ...
  def signups
    @page_title = tr("Your email notifications", "controller/settings", :instance_name => tr(current_instance.name,"Name from database"))
  ...
  # GET /settings/delete
  def delete
    @page_title = tr("Delete your {instance_name} account", "controller/settings", :instance_name => tr(current_instance.name,"Name from database"))
  end
