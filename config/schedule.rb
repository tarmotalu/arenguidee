...
set :output, "/home/yrpri2/sites/social-innovation/shared/log/cron_log.log"
...
every :reboot do
  rake "ts:index"
  rake "ts:start"
  command "cd /home/yrpri2/sites/social-innovation/current; RAILS_ENV=production ruby script/delayed_job start"
end
...
every 1.day do
  command "cd /home/yrpri2/sites/social-innovation/current; bundle exec backup perform -t daily_backup --config_file config/backup.rb --data-path db --log-path log --tmp-path tmp"
end
